  ...
  return (
    <div className='flex flex-col h-screen '>
      ...
      <div className='items-center  flex flex-col  gap-10 mt-20'>
        ...
        <Link to="/Room">
          <div
            className="cursor-pointer rounded-2xl w-50 h-15 bg-[#1C16D2] text-white text-2xl shadow-lg font-bold flex items-center justify-center hover:bg-[#0F0C62] transition-colors duration-300"
          >
            Crear Sala
          </div>
